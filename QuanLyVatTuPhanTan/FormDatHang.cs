...
{
    public partial class FormDatHang : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnTHEM_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (btnMENU.Links[0].Caption == "Đơn Đặt Hàng")
            {
                ...
                ((DataRowView)(bdsDonDatHang.Current))["MANV"] = Program.userID;
        ...
        private void btnGHI_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (Program.userID != maNhanVien && dangThemMoi == false)
            {
