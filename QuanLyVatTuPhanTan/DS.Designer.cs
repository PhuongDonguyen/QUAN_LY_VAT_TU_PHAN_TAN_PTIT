...
SELECT MasoDDH, MAVT, SOLUONG, DONGIA FROM CTDDH WHERE (MAVT = @MAVT) AND (MasoDDH = @MasoDDH)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLyVatTuPhanTan.Properties.Settings.Default.QLVTConnectionString;
        }
...
SELECT MAPN, MAVT, SOLUONG, DONGIA FROM CTPN WHERE (MAPN = @MAPN) AND (MAVT = @MAVT)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT MAPN, MAVT,TENVT = (SELECT TENVT FROM Vattu WHERE Vattu.MAVT = CTPN.MAVT)," +
                " SOLUONG, DONGIA\r\nFROM CTPN";
        ...
        public virtual int FillBy(DS.CTPNDataTable dataTable) {
        ...
        public virtual DS.CTPNDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DS.CTPNDataTable dataTable = new DS.CTPNDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
...
SELECT MasoDDH, NGAY, NhaCC, MANV, MAKHO FROM DatHang WHERE (MasoDDH = @MasoDDH)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"select  MasoDDH, NGAY, NhaCC, MANV,
TENV =(select  (RTRIM(LTRIM(HO)) + ' ' + LTRIM(TEN)) from NhanVien where NhanVien.MANV = DH.MANV),
MAKHO ,
TENKHO = (SELECT TENKHO FROM Kho WHERE KHO.MAKHO = DH.MAKHO)
from DatHang DH where MasoDDH not in (select MasoDDH from PhieuNhap)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillDdhChuaCoPN(DS.DatHangDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DS.DatHangDataTable GetDataDdhChuaCoPN() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DS.DatHangDataTable dataTable = new DS.DatHangDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
...
SELECT MANV, HO, TEN, SOCMND, DIACHI, NGAYSINH, LUONG, MACN, TrangThaiXoa FROM NhanVien WHERE (MANV = @MANV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT * FROM NHANVIEN\r\norder by TEN , HO";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillNhanVienOrder(DS.NhanVienDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
...
SELECT MAPN, NGAY, MasoDDH, MANV, MAKHO FROM PhieuNhap WHERE (MAPN = @MAPN)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT MAPN, NGAY, MasoDDH,MANV,(SELECT (RTRIM(LTRIM(HO)) + \' \' + LTRIM(TEN)) FRO" +
                "M NHANVIEN NV WHERE NV.MANV = PN.MANV ) AS  TENNV,\r\nMAKHO ,TENKHO = (SELECT TENK" +
                "HO FROM Kho WHERE KHO.MAKHO = PN.MAKHO)\r\nFROM PhieuNhap PN";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillPN(DS.PhieuNhapDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DS.PhieuNhapDataTable GetDataPNBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DS.PhieuNhapDataTable dataTable = new DS.PhieuNhapDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
